...
import { Camera, CameraOptions } from '@ionic-native/camera'; // 如果这里报错 ->  npm install --save @ionic-native/camera
...
export class EntryDetailPage {
  ...
  constructor(public navCtrl: NavController, public navParams: NavParams, private camera: Camera, private entryDataService: EntryDataServiceProvider, public alertController: AlertController) {
    ...
    if (entryID === undefined) {
      ...
      this.entry.image = PLACEHOLDER_IMAGE; // set the default view of image to placeholder
    } else {
